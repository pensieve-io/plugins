...
on first use; **Settings → Transcript sharing** can restart it. No setup
...
and does not trigger repeated prompts. Reconnect from **Settings → Transcript sharing** and continue in the agent with the same context selected.
